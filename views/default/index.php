...
$grid_columns                  = [
    ...
    [
        'attribute' => 'image',
        'contentOptions' => ['class' => 'image text-center',],
        'value' => function($model) {
            return '<img src="'.$model->src.'"/>';
        },
        'format' => 'raw',
    ],
    [
        'attribute' => 'name',
        'contentOptions' => ['width' => '300', 'class' => 'name'],
    ],
    [
        'attribute' => 'url',
    ...
    [
        'attribute' => 'is_active',
        'contentOptions' => ['class' => 'is_active'],
    ...
    [
        'attribute' => 'text_announcement',
        'contentOptions' => ['width' => '300', 'class' => 'text_announcement'],
    ],
    [
        'attribute' => 'timestamp',
